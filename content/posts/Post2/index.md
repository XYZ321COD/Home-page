...
Let's define  $\mathbf{z}_{p}^{q}$ as the  q-th entry in the vector obtained by flattening $z_{p}$, Using this, the final normalized kernel weights can be computed as:
